...
//                 </View>
//                 <View
//                   style={[styles.width50, styles.flexRow, styles.justifyEnd]}>
//                   <View>
//                     <SvgUri
...
//                     <TouchableOpacity>
//                       <Text
//                         style={[styles.font12, styles.textPri, styles.fontMed]}>
//                         View All
//                       </Text>
//                     </TouchableOpacity>
//                   </View>
              ...
              <View style={[styles.flexRow]}>
                <View style={[styles.width33, styles.padR8]}>
                  <View
                    ...
                    <Text
                      style={[styles.font12, styles.textDefault, styles.mb12]}>
                      {/* 200 Orders */}
                      {recentUserOne?.orders_count} Orders
                    </Text>
                    <TouchableOpacity
