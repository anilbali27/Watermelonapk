...
const SubCatalogueCard = (props) => {
  ...
  const EditSubCatalogue = (id) => {
    props.navigation.navigate("EditSubCatalogue", {id: props?.id,product_code:props?.product_code,subcatalogue_name:props?.category_name,subcatalogue_name:props?.category_name,amount_type:props?.amount_type})
  }
  ...
  const DeleteSubCateCatelogueAPICall = async () => {
    ...
    const result = await api.CreateMasterData(endPoint.delete_sub_catelogue, token, myJson);
    props.updateData();
    ...
    <>
        ...
        <View style={GlobalStyles.subCatalogueView}>
          <View>
            ...
            <View
              ...
              <TouchableOpacity onPress={() => EditSubCatalogue(props?.id)}>
                ...
                <View>
                  <TouchableOpacity onPress={() => DeleteSubCatelogue(props?.id)}>
        ...
        <View style={[styles.flexColumn, styles.alignCenter, styles.justifyCenter, styles.padt30]}>
          ...
          <View style={[styles.flexRow, styles.justifyCenter, styles.space_btn]}>
            ...
            <View style={[styles.width50, styles.PadL9]}>
              <TouchableOpacity style={[styles.continueBtn, styles.flexRow, styles.justifyCenter]} onPress={() => DeleteSubCateCatelogueAPICall()}>
      ...
      <RBSheet
        ...
        <View style={[styles.flexColumn, styles.alignCenter, styles.justifyCenter, styles.padt30]}>
          ...
          <Text style={[styles.font15, styles.textBlack, styles.mb37, styles.textCenter]}>Your sub catelogue deleted successfully</Text>
